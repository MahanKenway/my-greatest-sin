...
export default function SimulationHud({ snapshot, onCommand, packStatus, cacheProgress, flywireStage, onConfigurePack, onCachePack, benchmark, onRunOfficialBenchmark, pilot, pilotProtocol, onPilotActivationRateChange, onPilotInputAblationChange, onRunPilot }: Props) {
