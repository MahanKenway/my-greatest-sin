...
function MdCCrosswalkDisclosure() {
  return <div className="pilot-readout"><p className="micro-label">SWALLOW CIRCUIT / EVIDENCE GATE</p><strong>{MD_C_CROSSWALK_STATUS.label}</strong><div className="pack-state blocked"><span>ROOT CROSSWALK</span><strong>{MD_C_CROSSWALK_STATUS.status}</strong></div><p className="pack-message">{MD_C_CROSSWALK_STATUS.evidence} {MD_C_CROSSWALK_STATUS.audit} No broad pharyngeal candidate or MN9 substitution can run.</p></div>;
}
