...
import { LIF_SETTINGS_BOUNDS, type FlywireLifSettings, type FlywireSiteLevelLifReadiness } from "@/game/connectome/flywireSiteLevelLif";
...
type Props = {
  ...
  lifSettings: FlywireLifSettings;
  lifReadiness: FlywireSiteLevelLifReadiness;
  onLifSettingChange: (key: keyof FlywireLifSettings, value: number) => void;
  onRunSiteLevelLifPreflight: () => void;
...
export default function SimulationHud({ snapshot, onCommand, packStatus, cacheProgress, flywireStage, onConfigurePack, onCachePack, benchmark, onRunOfficialBenchmark, lifSettings, lifReadiness, onLifSettingChange, onRunSiteLevelLifPreflight, pilot, cpuCorridor, pilotProtocol, onPilotActivationRateChange, onPilotInputAblationChange, onRunPilot, onRunCpuCorridor, onCancelCpuCorridor }: Props) {
    ...
    <div className="lab-hud" aria-live="polite">
      ...
      <aside className="observation-rail left-rail">
        <section className="lab-pane specimen-pane">
          ...
          <EvidenceLedger showingFly={Boolean(showingFly)} usesSourceTopology={Boolean(usesSourceTopology)} executionLabel={execution?.label ?? "NO RUNTIME"} flywireStage={flywireStage} benchmark={benchmark} onRunOfficialBenchmark={onRunOfficialBenchmark} lifSettings={lifSettings} lifReadiness={lifReadiness} onLifSettingChange={onLifSettingChange} onRunSiteLevelLifPreflight={onRunSiteLevelLifPreflight} pilot={pilot} cpuCorridor={cpuCorridor} pilotProtocol={pilotProtocol} onPilotActivationRateChange={onPilotActivationRateChange} onPilotInputAblationChange={onPilotInputAblationChange} onRunPilot={onRunPilot} onRunCpuCorridor={onRunCpuCorridor} onCancelCpuCorridor={onCancelCpuCorridor} packStatus={packStatus} cacheProgress={cacheProgress} onConfigurePack={onConfigurePack} onCachePack={onCachePack} />
      </aside>
