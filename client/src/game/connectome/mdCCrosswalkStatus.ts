...
export const MD_C_CROSSWALK_STATUS = {
  ...
  materialization: "FAFB static snapshot v783 / CAVE materialization 783 (LTS)",
  audit: "Pinned v2.1.0 and current v3.1.0 annotations at materialization 783 have zero exact md-C, MN11 or MN12 labels; Codex/CAVE query access requires authenticated access.",
