...
- [ ] تأیید دوبارهٔ مجوز، روش دریافت رسمی، نسخه، هش و شرایط عدم‌بازتوزیع بستهٔ FlyWire v783 پیش از هر فعال‌سازی.
- [ ] اجرای benchmark واقعیِ sparse WebGPU روی دستگاه هدف با بستهٔ رسمی کامل و ثبت حافظه، زمان گام و پایداری مرورگر.
- [ ] فعال‌سازی فقط ستون‌های checksum-verified رسمی در مسیر مگس؛ حذف هر مسیر آزمایشی یا نمایش‌دهنده از نتایج ادعاشدهٔ شبکه.
- [ ] طراحی و مستندسازی جداگانهٔ نگاشت حسگرهای محیط به گروه‌های نورونی و نگاشت نورون‌ها به عضلات؛ هر بخش فاقد شواهد مستقیم باید `MODELLED MAPPING` بماند.
