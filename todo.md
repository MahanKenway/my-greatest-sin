...
- [ ] بررسی remote و شاخهٔ پروژه، سپس ثبت نسخهٔ فعلی در مخزن GitHub منتخب بدون حذف کار محلی.
- [ ] بازتولید وضعیت «مدل دیده نمی‌شود / زمین مشکل دارد» در نشست تازه و ثبت علت فنی قابل‌آزمون.
- [ ] اصلاح دوربین، نور، چیدمان مدل یا هندسه/متریال زمین فقط پس از مشاهدهٔ مستقیم اشکال.
- [ ] تأیید مگس و C. elegans، تعویض گونه، زمین و کنسول مرورگر؛ سپس اجرای type check، آزمون و build.
