...
- [ ] پیاده‌سازی اجرایی پایلوت زیرمدار با آزمون تحریک و خوانش خروجی؛ قرارداد و نمای `SOURCE DATA`/`MODELLED MAPPING` آماده است، اما تا دسترسی به adapter معتبر فعال نمی‌شود.
